...
## Interactive checks {#sec-11-interactive .unnumbered}

A round of quick interactive drills to close the revision - instant feedback, all in your browser, nothing recorded. Every task has a show-solution button; clicking it straight away is no fun.

{{< include _tasks/11-journey.qmd >}}

{{< include _tasks/11-layers.qmd >}}

{{< include _tasks/11-binary.qmd >}}

{{< include _tasks/11-entropy.qmd >}}

{{< include _tasks/11-models.qmd >}}

{{< include _tasks/11-blocks.qmd >}}
